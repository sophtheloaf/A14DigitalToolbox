...
public class PlayerMovement : MonoBehaviour
{
	...
	public Rigidbody rb;
	public float forwardForce = 20;  // Variable that determines the forward force
	// public float sidewaysForce = 20;  // Variable that determines the sideways force
	...
	void Movement()
	{
		if (Input.GetKey("w"))  // If the player is pressing the "w" key
		{
			...
			rb.AddForce(direction.forward * forwardForce);
		}
